            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    <div class="register-out">
                        ...
                        <a class="register" href="http://demo.bestprestashoptheme.com/savemart/en/login?create_account=1" data-link-action="display-register-form">
                            Register
                        </a>
                        <span class="or-text">or</span>
                        <a class="login" href="http://demo.bestprestashoptheme.com/savemart/en/my-account" rel="nofollow" title="Log in to your customer account">Sign in</a>
                    </div>
                        ...
                        <div class="currency-list dropdown-menu">
                            <div class="currency-list-content text-left">
                                <div class="currency-item current flex-first">
                                    <a title="British Pound" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">£ GBP</a>
                                </div>
                                <div class="currency-item">
                                    <a title="US Dollar" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">$ USD</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="_desktop_language_selector" class="language-selector groups-selector hidden-sm-down language-selector-dropdown">
                        <div class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="main">
                            <span class="expand-more"><img class="img-fluid" src="{{asset('assets/front/images/1.png')}}" alt="English" width="16" height="11"/></span>
                        </div>
                                ...
                                <div class="language-item current flex-first">
                                    <div class="current">
                                        <a href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&SubmitCurrency=1&id_currency=1">
                                            <img class="img-fluid" src="{{asset('assets/front/images/1.png')}}" alt="English" width="16" height="11"/>
                                            <span>English</span>
                                        </a>
                                    </div>
                                </div>
