...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/front/images/logo.ico')}}">
    ...
    <link rel="stylesheet" href="http://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/cache/theme-78026624.css" type="text/css" media="all">
    ...
    <script type="text/javascript">
        ...
        var prestashop = {
            ...
            "urls": {
                ...
                "current_url": "http:\/\/demo.bestprestashoptheme.com\/savemart\/en\/?home=home_3&SubmitCurrency=1&id_currency=1",
            ...
            <div>
                <div id="_mobile_account_list">
                    <div class="account-list-content">
                        <div>
                            <a class="login" href="http://demo.bestprestashoptheme.com/savemart/en/my-account" rel="nofollow" title="Log in to your customer account"><i class="fa fa-sign-in"></i>Sign in</a>
                        </div>
                        <div>
                            <a class="register" href="http://demo.bestprestashoptheme.com/savemart/en/my-account" rel="nofollow" title="Register Account"><i class="fa fa-user"></i>Register Account</a>
                        </div>
                        <div>
                            <a class="check-out" href="http://demo.bestprestashoptheme.com/savemart/en/order" rel="nofollow" title="Checkout"><i class="material-icons">check_circle</i>Checkout</a>
                        </div>
                        <div class="link_wishlist">
                            <a href="http://demo.bestprestashoptheme.com/savemart/en/module/novblockwishlist/mywishlist" title="My Wishlists">
        ...
        <div id="box-currency" class="box-content d-flex">
            <div class="w-100">
                <div class="item-currency current">
                    <a title="British Pound" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">British Pound: GBP</a>
                </div>
                <div class="item-currency">
                    <a title="US Dollar" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">US Dollar: USD</a>
                </div>
            </div>
        </div>
...
<div id="stickymenu_bottom_mobile" class="d-flex align-items-center justify-content-center hidden-md-up text-center">
    ...
    <div class="stickymenu-item"><a href="http://demo.bestprestashoptheme.com/savemart/en/module/novblockwishlist/mywishlist"><i class="zmdi zmdi-favorite-outline"></i><span>Wishlist</span></a></div>
