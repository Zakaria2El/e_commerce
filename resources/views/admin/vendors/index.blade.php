                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> All vendors
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">All Vendors of the site </h4>
                                            ...
                                            @isset($vendors)
                                                @foreach($vendors as $vendor)
                                                    <tr>
                                                        ...
                                                        <td >{{$vendor->getActive()}}
                                                            @if($vendor->getActive()=='Active') <span class="badge badge badge-success badge-pill float-right mr-2" > | </span>
