                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> All languages
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            @isset($languages)
                                                @foreach($languages as $language)
                                                    <tr>
                                                        ...
                                                        <td >{{$language->getActive()}}
                                                            @if($language->getActive()=='active') <span class="badge badge badge-success badge-pill float-right mr-2" > | </span>
