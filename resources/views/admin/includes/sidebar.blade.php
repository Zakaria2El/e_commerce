<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="#"><i class="la la-language"></i><span class="menu-title" data-i18n="nav.dash.main">Languages</span>
                    <span class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Language::count()}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.languages')}}" data-i18n="nav.dash.ecommerce">All Languages</a>
                    </li>
                    <li class=""><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">Add New Language</a>
                    </li>

                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-clipboard"></i><span class="menu-title" data-i18n="nav.dash.main">Main Categories</span>
                    <span class="badge badge badge-danger badge-pill float-right mr-2">{{\App\Models\MainCategory::where('translation_lang',locale())->count()}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.maincategories')}}" data-i18n="nav.dash.ecommerce">All Main Categories</a>
                    </li>
                    <li class=""><a class="menu-item" href="{{route('admin.maincategories.create')}}" data-i18n="nav.dash.crypto">Add New Main Category</a>
                    </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Vendors</span>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.vendors')}}" data-i18n="nav.dash.ecommerce">All Vendors</a>
                    </li>
                    <li class=""><a class="menu-item" href="{{route('admin.vendors.create')}}" data-i18n="nav.dash.crypto">Add New Vendor</a>
                    </li>
